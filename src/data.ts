...
export const PROPERTIES: Property[] = [
  ...
  {
    id: "birch-emerald-estates",
    name: "Birch House Model at Emerald Estates",
    location: "Iloilo",
    area: "Beside Iloilo Sunset Boulevard, Oton / Mandurriao, Iloilo",
    type: "2-Storey Single / Townhouse",
    badge: "Available",
    beds: 2,
    baths: 2,
    parking: 1,
    sqm: 45,
    lotNote: "60 sqm lot · 45 sqm floor area · Sunset Boulevard Access",
    price: 11635.52,
    priceLabel: "Monthly amortization starts at",
    priceNote: "2 Bedrooms · 2 Bathrooms · Provision for Balcony & Carport",
    img: "/assets/img/birch-model.jpg",
    gallery: ["/assets/img/birch-model.jpg"],
    tagline: "Modern two-storey residence with 2 bedrooms, 2 bathrooms, provision for balcony & carport right beside Iloilo Sunset Boulevard.",
    highlights: [
      "Strategic location beside Iloilo Sunset Boulevard with smooth city connectivity",
      "45 sqm efficient floor area across two storeys on a 60 sqm lot",
      "2 bedrooms and 2 complete bathrooms",
      "Dedicated provisions for outdoor balcony and private carport",
      "Open living and dining spaces with modern green aesthetic finishes",
      "Gated community with 24/7 security, clubhouse & landscaped open spaces",
    ],
    developer: "Emerald Estates",
    category: "sale",
  },
  {
    id: "cypress-emerald-estates",
    name: "Cypress House Model at Emerald Estates",
    location: "Iloilo",
    area: "Beside Iloilo Sunset Boulevard, Oton / Mandurriao, Iloilo",
    type: "2-Storey Single / Townhouse",
    badge: "Available",
    ...
    parking: 1,
    sqm: 76.23,
    lotNote: "60 sqm lot · 76.23 sqm floor area · Built-in Balcony",
    price: 10631.39,
    priceLabel: "Monthly amortization starts at",
    priceNote: "3 Bedrooms · 2 Bathrooms · Balcony · Carport · Living & Dining",
    img: "/assets/img/cypress-model.jpg",
    gallery: ["/assets/img/cypress-model.jpg"],
    tagline: "Spacious 3-bedroom, 2-bathroom modern two-storey home with balcony and carport beside Iloilo Sunset Boulevard.",
    highlights: [
      "Expansive 76.23 sqm floor area on a 60 sqm lot",
      "3 comfortable bedrooms and 2 complete bathrooms",
      "Private built-in second-floor balcony",
      "Dedicated covered carport area and front green strip",
      "Immediate proximity to Iloilo Sunset Boulevard for quick city transit",
      "Safe, master-planned community with lifestyle amenities and round-the-clock security",
    ],
    developer: "Emerald Estates",
    category: "sale",
  },
  {
    id: "eleve-homes-tagaytay",
    name: "Elevé Homes Tagaytay",
    location: "Tagaytay",
    area: "A. Cruz Herrera St., Continental Subd., Maharlika West, Tagaytay City",
    type: "Modern Townhome / Weekend Villa",
    badge: "Featured",
    beds: 3,
    baths: 2,
    parking: 1,
    sqm: 85,
    lotNote: "Perfect Weekend Getaway · Cool Mountain Air",
    price: 6_800_000,
    priceLabel: "Price starts at",
    priceNote: "3 Bedrooms · 2 Toilet & Bath · 1 Carport · Continental Subdivision",
    img: "/assets/img/eleve-tagaytay.jpg",
    gallery: ["/assets/img/eleve-tagaytay.jpg"],
    tagline: "Your perfect weekend getaway — modern multistory residence with balcony, carport, and mountain ambiance in Maharlika West, Tagaytay.",
    highlights: [
      "Nestled inside Continental Subdivision along Maharlika West, Tagaytay City",
      "3 spacious bedrooms and 2 complete toilet & baths",
      "Dedicated secure carport and private second-floor balconies",
      "Modern architectural design with stone, wood, and steel accents",
      "Community clubhouse, landscaped arrival rotunda, and 24/7 security gatehouse",
      "Enjoy cool Tagaytay breeze year-round just minutes from scenic ridge restaurants",
    ],
    developer: "Elevé Homes",
    category: "sale",
  },
  {
    id: "firenze-iloilo-business-park",
    name: "Firenze at Iloilo Business Park",
    location: "Iloilo",
    area: "Iloilo Business Park, Mandurriao, Iloilo City",
    type: "Italian-Themed Luxury Condominium Tower",
    badge: "Pre-Selling",
    beds: 1,
    baths: 1,
    parking: 1,
    sqm: 32,
    lotNote: "Italian-Themed Tower · Artful Living Spaces",
    price: 4_500_000,
    priceLabel: "Price starts at",
    priceNote: "Studio, 1BR & Executive Suites · Timeless Elegance in Iloilo's Premier Township",
    img: "/assets/img/firenze-iloilo.jpg",
    gallery: ["/assets/img/firenze-iloilo.jpg"],
    tagline: "An Italian-themed residential tower offering artful living spaces, private dining, sky gardens, and wellness amenities in Iloilo's premier township.",
    highlights: [
      "Italian-inspired architectural grandeur located inside Megaworld's 72-hectare Iloilo Business Park",
      "Curated living spaces tailored for those who seek beauty, comfort, and exclusivity",
      "State-of-the-art wellness amenities, sky gardens, private dining suites, and infinity pool",
      "Steps from Festive Walk Mall, Iloilo Convention Center, and multinational corporate hubs",
      "High capital appreciation potential and robust rental demand from executives and tourists",
      "Sophisticated lobby with 24/7 concierge and multi-tier biometric security",
    ],
    developer: "Megaworld Corporation",
    category: "sale",
  },
  {
    id: "bernwood-resort-residences",
    name: "Bernwood Resort Residences",
    location: "Iloilo",
    area: "E. Lopez St., Jaro / Mandurriao, Iloilo City",
    type: "Mid-Rise Resort Condominium Community",
    badge: "Available",
    beds: 2,
    baths: 1,
    parking: 1,
    sqm: 48,
    lotNote: "Resort-Inspired Living · Central Lagoon Pool",
    price: 3_600_000,
    priceLabel: "Price starts at",
    priceNote: "Resort Condominium · Lap Pool & Cabanas · Gated Community",
    img: "/assets/img/bernwood-residences.jpg",
    gallery: ["/assets/img/bernwood-residences.jpg"],
    tagline: "Relaxed resort-style residential community with twin mid-rise towers centered around a sparkling swimming lagoon and tropical gardens.",
    highlights: [
      "Mid-rise resort condominium buildings offering relaxed, low-density community living",
      "Grand central swimming pool with poolside cabanas, sun loungers, and tropical palm gardens",
      "Community clubhouse, fitness center, and children's play park",
      "Strategic Iloilo location accessible to universities, shopping malls, and medical centers",
      "Round-the-clock gated security, perimeter surveillance, and dedicated property management",
      "Perfect choice for young professionals, growing families, and lifestyle investors",
    ],
    developer: "Bernwood Properties",
    category: "sale",
  },
  {
    id: "maple-plus-emerald-estates",
    name: "Maple Plus House Model at Emerald Estates",
    location: "Iloilo",
    area: "Beside Iloilo Sunset Boulevard, Oton / Mandurriao, Iloilo",
    ...
    parking: 1,
    sqm: 65,
    lotNote: "60–65 sqm lot · 60–65 sqm floor area · Sunset Boulevard",
    price: 11350.75,
    priceLabel: "Monthly amortization starts at",
    priceNote: "3 Bedrooms · 2 Toilet & Baths · Balcony & Carport Provisions · Open Lawn",
    img: "/assets/img/maple-plus-facade.jpg",
    gallery: [
      "/assets/img/maple-plus-facade.jpg",
      "/assets/img/maple-plus-plan.jpg",
    ],
    tagline: "Two-storey single-attached 3-bedroom residence with balcony and carport provisions, laundry service area, and open lawn beside Iloilo Sunset Boulevard.",
    highlights: [
      "Strategic direct access beside Iloilo Sunset Boulevard for quick city connectivity",
      "65 sqm floor area on a typical 60–65 sqm lot",
      "3 bedrooms and 2 complete toilet and baths",
      "Dedicated provisions for upper balcony and private carport",
      "Spacious ground-floor dining, modern kitchen, living area, and open green lawn",
      "Gated community with 24/7 security, clubhouse & landscaped recreational spaces",
    ],
    developer: "Emerald Estates",
    category: "sale",
  },
  {
    id: "palm-emerald-estates",
    name: "Palm House Model at Emerald Estates",
    location: "Iloilo",
    area: "Beside Iloilo Sunset Boulevard, Oton / Mandurriao, Iloilo",
    type: "Single-Attached 2-Storey Executive Home",
    badge: "Available",
    beds: 4,
    baths: 3,
    parking: 2,
    sqm: 73.27,
    lotNote: "80 sqm lot · 73.27 sqm floor area · 2-Carport Provision",
    price: 18516.86,
    priceLabel: "Monthly amortization starts at",
    priceNote: "4 Bedrooms · 3 Toilet & Baths · 2 Carport Provision · Balcony",
    img: "/assets/img/palm-model-facade.jpg",
    gallery: [
      "/assets/img/palm-model-facade.jpg",
      "/assets/img/palm-model-plan.jpg",
    ],
    tagline: "Spacious 4-bedroom executive single-attached residence with double carport provision, 3 bathrooms, and balcony beside Iloilo Sunset Boulevard.",
    highlights: [
      "Generous 80 sqm lot with 73.27 sqm floor layout across two functional storeys",
      "4 spacious bedrooms (including master's suite) and 3 complete toilet & baths",
      "Double carport provision accommodating 2 family vehicles",
      "Private upper balcony provision with breezy open outlook",
      "Integrated ground-floor porch, living room, dining area, kitchen, and service laundry area",
      "Nestled inside a secure master-planned community right along Iloilo Sunset Boulevard",
    ],
    developer: "Emerald Estates",
    category: "sale",
  },
  {
    id: "the-emerald-model",
    name: "The Emerald Executive House Model",
    location: "Iloilo",
    area: "Beside Iloilo Sunset Boulevard, Oton / Mandurriao, Iloilo",
    type: "Single-Attached 2-Storey Luxury Residence",
    badge: "Featured",
    beds: 4,
    baths: 3,
    parking: 2,
    sqm: 106,
    lotNote: "100 sqm lot · 106–111 sqm floor area · Den & Balcony",
    price: 22049.40,
    priceLabel: "Monthly amortization starts at",
    priceNote: "4 Bedrooms · 3 T&B · Den · Wide Balcony · Covered 2-Car Parking Area",
    img: "/assets/img/the-emerald-facade.jpg",
    gallery: [
      "/assets/img/the-emerald-facade.jpg",
      "/assets/img/the-emerald-plan.jpg",
    ],
    tagline: "Flagship executive two-storey home featuring 4 bedrooms, 3 bathrooms, dedicated den/home office, covered 2-car garage, and expansive terrace balcony.",
    highlights: [
      "100 sqm lot with 106 to 111.17 sqm of luxurious living space",
      "4 full bedrooms plus versatile private den / library / home office space",
      "3 complete designer bathrooms with premium fixtures",
      "Wide second-floor terrace balcony with stone accent facade",
      "Covered parking area for up to 2 cars plus private garden service area",
      "Prime estate address beside Iloilo Sunset Boulevard with clubhouse, swimming pool & 24/7 security",
    ],
    developer: "Emerald Estates",
    category: "sale",
  },
  {
    id: "the-palladium-iloilo",
    name: "The Palladium at Iloilo Business Park",
    location: "Iloilo",
    area: "Megaworld Blvd., Iloilo Business Park, Mandurriao, Iloilo City",
    ...
    parking: 1,
    sqm: 35,
    lotNote: "Iconic 22-Storey Tower · Skygardens · Infinity Pool",
    price: 5_200_000,
    priceLabel: "Price starts at",
    priceNote: "Luxury Condominium Suites · Multi-Level Skygardens · Festive Walk Frontage",
    img: "/assets/img/the-palladium.jpg",
    gallery: ["/assets/img/the-palladium.jpg"],
    tagline: "The iconic 22-storey tower that defines luxury living in Iloilo Business Park, featuring multi-level skygardens and Western Visayas' highest infinity pool.",
    highlights: [
      "Standing 22 storeys tall as one of the tallest residential towers in Western Visayas",
      "Exclusive multi-level skygardens and an outdoor infinity pool overlooking the city skyline",
      "Direct frontage along Megaworld Boulevard, walking distance to Festive Walk Mall and Richmond Hotel",
      "Complete lifestyle amenities: fitness gym, spa, outdoor cabanas, and private function rooms",
      "High-return rental investment favored by multinational business executives and BPO expatriates",
      "Round-the-clock biometric security, grand reception lobby, and dedicated concierge",
    ],
    developer: "Megaworld Corporation",
    category: "sale",
  },
  {
    id: "the-southprime-flats",
    name: "The Southprime Flats",
    location: "Iloilo",
    area: "Southprime Boulevard / Mandurriao, Iloilo City",
    type: "Modern Smart Residential Condominium",
    badge: "New Launch",
    beds: 1,
    baths: 1,
    parking: 1,
    sqm: 28,
    lotNote: "Live Smart · Live Modern · Prime Urban Hub",
    price: 2_950_000,
    priceLabel: "Price starts at",
    priceNote: "Smart Condominium Units · Low Density · Accessible Transport",
    img: "/assets/img/southprime-flats.jpg",
    gallery: ["/assets/img/southprime-flats.jpg"],
    tagline: "Live smart, live modern — contemporary twin-tower condominium development offering efficient living spaces in a prime accessible Iloilo location.",
    highlights: [
      "Modern architectural facade designed with natural ventilation and energy-efficient elements",
      "Smart-space planned studio and 1-bedroom units ideal for young professionals and university students",
      "Gated residential complex with swimming pool, commercial ground shops, and secure parking",
      "Fast commute to city center, medical clinics, schools, and central business districts",
      "Affordable entry price point with high capital appreciation and rental yield potential",
      "Equipped with CCTV perimeter monitoring, high-speed elevators, and backup power generator",
    ],
    developer: "Southprime Development",
    category: "sale",
  },
  {
    id: "the-pinnacle-iloilo-business-park",
    name: "The Pinnacle at Iloilo Business Park",
    location: "Iloilo",
    area: "Iloilo Business Park, Mandurriao, Iloilo City",
    type: "Modern High-Rise Residential Tower",
    badge: "Pre-Selling",
    beds: 1,
    baths: 1,
    parking: 1,
    sqm: 34,
    lotNote: "Smart Stylish Suites · Resort-Style Pool & Gym",
    price: 4_800_000,
    priceLabel: "Price starts at",
    priceNote: "Smart & Stylish Studio, 1BR & 2BR Units · Steps from Lifestyle Hubs",
    img: "/assets/img/the-pinnacle-iloilo.jpg",
    gallery: ["/assets/img/the-pinnacle-iloilo.jpg"],
    tagline: "A modern residential tower with smart, stylish units and resort-style amenities — lobby, pool, and fitness gym just steps from Iloilo Business Park lifestyle and corporate hubs.",
    highlights: [
      "Modern residential tower inside Megaworld's 72-hectare premier Iloilo Business Park township",
      "Smart-home ready stylish suites with panoramic city & sunset vistas",
      "Resort-style swimming pool, sun deck, fitness gym, and designer reception lobby",
      "Immediate walking access to Festive Walk Mall, Richmond Hotel, and multinational BPO offices",
      "High rental demand and capital growth in Western Visayas' top commercial district",
      "Multi-tier 24/7 security with biometric keycard elevators and concierge",
    ],
    developer: "Megaworld Corporation",
    category: "sale",
  },
  {
    id: "the-perch-highland-park",
    name: "The Perch at Highland Park",
    location: "Antipolo",
    area: "Highland Park, Antipolo / Rizal Highlands",
    type: "Hillside View Residential Subdivision Lots",
    badge: "Featured",
    beds: 3,
    baths: 2,
    parking: 2,
    sqm: 180,
    lotNote: "Rolling Hillside Terrain · Panoramic Metro Skyline Views",
    price: 7_500_000,
    priceLabel: "Starting Lot / Package Price",
    priceNote: "Elevated Hillside Lots & Custom Mountain Home Packages · Cool Climate",
    img: "/assets/img/the-perch-highland-park.jpg",
    gallery: ["/assets/img/the-perch-highland-park.jpg"],
    tagline: "Exclusive hillside residential enclave overlooking the metropolitan skyline, featuring covered sports complex, outdoor courts, and pristine mountain air.",
    highlights: [
      "Commanding elevated views of the Metro Manila skyline and surrounding green valleys",
      "Master-planned rolling terrain with wide concrete roads, underground drainage, and landscaped parks",
      "Covered community sports complex and twin outdoor basketball & sports courts",
      "Refreshing cool mountain breeze all year round, away from city congestion and flood-free",
      "Gated community with 24/7 security gatehouse, roving patrols, and perimeter fencing",
      "Ideal setting for vacation homes, executive retreats, and nature-inspired family living",
    ],
    developer: "Highland Park Developments",
    category: "sale",
  },
];
